        ...
        for l in wkt_list:
            ...
            for p in range(len(points)):
                ...
                if p == 0:
                    ...
                    if cand in outstring:
                        print(f'[WARNING] avoid --> `Duplicate section Error`')
                        pass
                    else:
                        outstring += cand
            outstring += ")"
...
if __name__ == "__main__":
    ...
    for img_loc in images:
        ...
        img, ske = make_skeleton(img_loc, thresh=0.4, debug=False, 
                                    fix_borders=False, replicate=5,
                                    clip=2, img_shape=(1312, 1312), img_mult=255, hole_size=50,
                                    cv2_kernel_close=7, cv2_kernel_open=7,
                                    use_medial_axis=False,
                                    max_out_size=(200000, 200000),
                                    num_classes=1,
