...
if __name__ == '__main__':
    ...
    class CFG(object):
        ...
        # area_, clean-v1_, clean-v3_ clean-v5_ , '', fulltrain_,
        csv_state: str = 'clean-v4_'
        ...
        weight: str = '../../train/output/flood/3090_V5_clean-v3__timmu_IMG1312_hrnet_w18_fl-tr_b4/'
        mixup: float = 0.0
        ...
        runname: str = "3090"
        group: str = f'3090_V7_FINE_{csv_state}_{model["architecture"]}_IMG{preprocess["input_size"]}_fl-tr_b4'
        notebook: str = 'baseline_flood_fine.py'
    ...
    for fold in range(cfg.folds):
        ...
        model = SpaceNet8Model.load_from_checkpoint(
            f'{cfg.weight}3090_fold-{fold}/best_fold-{fold}.ckpt', cfg=cfg)
